...
\begin{center}
   \begin{tikzpicture}
      ...
      \def\ar{1.0}      % Radius of the arc that represents the angle
      ...
      \draw (\angle:\r+\br) circle [radius=\br];        % The small circle representing the bob

      \draw [->,>=stealth] (0, -\ar) arc (-90:\angle:\ar);
      \draw (-105:\ar+0.25) node {$\theta$};
